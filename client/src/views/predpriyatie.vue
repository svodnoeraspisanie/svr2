  ...
  data: () => ({
    ...
    predpriyatiya: [
      ...
      },
      {
        ...
        sozdano: "",
        kratkoe_opisanie:
          "Розанов Клуб - это открытое собрание добрых русских людей и единственная национальная площадка в которой мы собрали все виды контента: живые лекции, экскурсии, статьи, видеоролики, стримы и подкасты. Мы всегда открыты к сотрудничесву и готовы принять новых людей.",
        podrobnoe_opisanie: "",
      ...
      },
      {
        ...
        sozdano: "2019",
        kratkoe_opisanie:
          "Независимый проект по сбору и анализу информации связанной с этнопреступностью в Российской Федерации.",
        podrobnoe_opisanie: "",
        obraz: "/obrazy/ethnocrime.png",
        ssilki: {
          "Сайт":"http://etnocrime.info",
          "Элпочта":"mailto:etnocrime@protonmail.com",
